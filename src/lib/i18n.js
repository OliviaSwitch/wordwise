...
export const messages = {
  en: {
    ...
    'settings.gloss': 'Gloss Pack',
    'settings.glossHint': 'The gloss pack (en-zh.json) drives annotation. Download it from the deployment, or import it from a local file.',
    'settings.downloadGloss': 'Download Gloss Pack',
    'settings.importGloss': 'Import Gloss Pack',
    'settings.glossDownloaded': 'Gloss pack downloaded',
    'settings.glossDownloadFailed': 'Download failed: {msg}',
    'settings.glossImported': 'Gloss pack imported',
    'settings.glossImportFailed': 'Gloss pack import failed: {msg}',
    ...
    // Gloss
    'gloss.warning': 'Gloss pack data (en-zh.json) is missing. Go to Settings to download or import it.',
    'gloss.goToSettings': 'Go to Settings',
    // EPUB
  ...
  zh: {
    ...
    'settings.gloss': '词包',
    'settings.glossHint': '词包（en-zh.json）驱动标注。可从部署源下载，或从本地文件导入。',
    'settings.downloadGloss': '下载词包',
    'settings.importGloss': '导入词包',
    'settings.glossDownloaded': '词包已下载',
    'settings.glossDownloadFailed': '下载失败：{msg}',
    'settings.glossImported': '词包已导入',
    'settings.glossImportFailed': '词包导入失败：{msg}',
    ...
    // Gloss
    'gloss.warning': '词包数据（en-zh.json）缺失。请前往设置下载或导入。',
    'gloss.goToSettings': '前往设置',
    // EPUB
    'epub.untitled': '未命名',
  },
};
